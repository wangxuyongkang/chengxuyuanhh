  ...
  <div>
            ...
            <div class="bd">
              <div class="tempWrap" style="overflow:hidden; position:relative; width:330px">
                <ul class="cle"
                  ...
                  <!-- 小图列表项 -->
                  <li v-for="(item, index) in proDetail.images" :key="index" :class="{'current': index === curIndex}"
            ...
            <dd class="property">
              <ul>
                ...
                <li>
                  ...
                  class="red">{{proDetail.sold_num}}</em>件</span>
                </li>
              </ul>
            </dd>
            <dd class="tobuy-box cle">
              <ul class="sku">
                <li class="skunum_li cle">
                  ...
                  <div class="skunum"><span class="minus" title="减少1个数量" @click="reduceNum"><i
    ...
    <div class="detail_bgcolor">
      <div class="z-detail-box cle">
        ...
        <!-- 热卖商品 -->
        <hot-sales @on-hot="hotChange"></hot-sales>
