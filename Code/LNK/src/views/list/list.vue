<template>
  <div id="wrapper">
    ...
    <div class="main cle">
      <list-nav :currentCategoryName="currentCategoryName" :cateMenu="cateMenu" :isObject="isObject"
                :proNum="proNum" @on-change="changeMenu"></list-nav>
      ...
      <div class="maincon">
        ...
        <div class="list-detail">
          ...
          <Page @pagefn="pagefn" :page="curPage" :totalPage="totalPage" pre-text="上一页" next-text="下一页"
                end-show="true"></Page>
        </div>
      </div>
    </div>
...
<script>
  import {getCategory, getCurLoc, getPriceRange, getGoods} from '../../api/api'

  import currentLoc from './current-loc/currentLoc'
