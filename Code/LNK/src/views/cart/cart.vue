      ...
      <div class="goods-list">
        <ul>
          ...
          <li class="cle hover" style="border-bottom-style: none;" v-for="(item,index) in goods_list" :key="index">
            <div class="pic">
              <a target="_blank"> <img :alt="item.goods.name" :src="item.goods.image"></a>
            </div>
            <div class="name">
    ...
    balanceCount () { // 结算
      if (this.address === '') {
        ...
        createOrder({
          ...
          signer_name: this.signer_name, // 姓名
          signer_mobile: this.signer_mobile, // 电话
